...
with open("C:\\Users\\HP\\Desktop\\Mails\\index3.html", 'r') as html_file:
...
with open("C:\\Users\\HP\\Desktop\\Mails\\email testing.csv", 'r') as csvfile:
    ...
    for row in datareader:
        ...
        # Add plain text alternative (optional) and HTML content
        em.set_content("Your email client does not support HTML content.")  # Plain text fallback
        em.add_alternative(html_content, subtype='html')  # HTML content
...
server.close()
print("Done @Cors(Survey of India)")
